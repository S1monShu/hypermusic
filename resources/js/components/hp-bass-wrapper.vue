<template>
    <div class="hp-electric">
        ...
        <div class="hp-electric-wrapper">
         ...
         <div class="catalog">
            <hpCatalog v-bind:guitars="paginatedGuitarsList" v-bind:path="pathBass"/>
...
import { mapActions, mapGetters } from 'vuex';
    ...
    export default{
        name: 'hp-bass-wrapper',
        data(){
            return {
                model_options: [
                    {name: 'Concert Bass', value: 1},
                    {name: 'Violin Bass', value: 2},
                    {name: 'Club Bass', value: 3},
                    {name: 'Double cut', value: 4},
                    {name: 'Jazz Bass', value: 5},
                    {name: 'StingRay', value: 6},
                    {name: 'Precision Bass', value: 7},
                    {name: 'Fusion', value: 8},
                    {name: 'Spectra', value: 9},
                    {name: 'Single cut', value: 10},
                ],
                orientation_options: [
                    {name: 'под правую руку', value: 11},
                    {name: 'под левую руку', value: 12},
                ],
                creators_options: [
                    {name: 'Jackson', value: 13},
                    {name: 'Hofner', value: 14},
                    {name: 'Ibanez', value: 15},
                    {name: 'Squier by Fender', value: 16},
                    {name: 'Sterling', value: 17},
                    {name: 'G&L', value: 18},
                    {name: 'Warwick', value: 19},
                    {name: 'Cort', value: 20},
                    {name: 'Gretsch', value: 21},
                    {name: 'Yamaha', value: 22},
                    {name: 'Guild', value: 23},
                    {name: 'Sire', value: 24},
                    {name: 'Dean Guitars', value: 25},
                    {name: 'LTD', value: 26},
                    {name: 'Spector', value: 27},
                ],
                cardsPerPage: 12,
                pageNumber: 1,
                maxVisibleButtons: 3,
    ...
    hpSelect,
        ...
        computed: {
            ...
            if (!this.options.length == 0){
                ...
                let filteredList = toRaw(this.BASS_GUITARS)
...
<style scoped>
    ...
    #hp-page-theme{
      background-image: url(../assets/images/bass.png);
       height: 128px;
       font-family: 'Jost';
       font-weight: 600;
       font-size: 32px;
